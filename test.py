...
# for i in range(1, 11):
#     path = "data/csv/popular_music_" + str(i) + ".csv"
#     df = pd.read_csv(path)
#     data.append(df)

# finalDf = pd.concat(data)
# finalDf.to_csv("data/csv/popular_music_sum.csv")
...
# df.index = index
# df.to_csv("data/csv/popular_final_sum2.csv")

# 공백 제거

# df = pd.read_csv("data/csv/popular_final_sum2.csv")
# df_dop_row = df.dropna(axis=0)

# row, col = df_dop_row.shape
# index = [i for i in range(row)]
# df_dop_row.index = index
# df_dop_row.to_csv("data/csv/popular_final_sum.csv")
